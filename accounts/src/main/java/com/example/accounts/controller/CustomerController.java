...
public class CustomerController {
    ...
    public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@Pattern(regexp = "^\\d{10}$", message = "Mobile Number should be exactly 10 digits long.") @RequestParam String mobileNumber) {
